...
Roadmap v3.2 phase work lives in notebooks, configuration, and data artifacts rather than phase-mirrored source folders. Keep this tree limited to modules that are intended to be imported by multiple workflows, such as `src/utils/paths.py`.
