...
- [`../config/artifact_registry.json`](../config/artifact_registry.json) records frozen derived-artifact identity and lineage, including the notebook-450 primary gene × program association handoff.
