...
**Status:** **IN PROGRESS — notebooks 600–602 complete under frozen specifications; notebook 603 prospectively frozen and pending implementation/execution.**
...
- **Notebook 603 boundary:** the cross-screen replication specification was prospectively frozen on 2026-09-22 before CTRP/PRISM replication-result inspection. Primary replication is restricted to frozen notebook-600 GDSC FDR-controlled hypotheses with frozen exact-compound matching and frozen external eligibility; CTRP and PRISM use separate screen-specific FDR families, explicit direction concordance, and overlap-aware full-screen/non-overlap analyses. Notebook-601 and notebook-602 evidence remains isolated from primary replication decisions and may only be appended later as separately traceable context.
