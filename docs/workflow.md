...
- **Repository handoff:** notebook-601 partitions, repeat-level performance, LOLO performance, integrated drug-level results, and analysis metadata are registered as frozen `phase6.601.*` artifacts under `data/processed/pharmacogenomic_contexts`.
