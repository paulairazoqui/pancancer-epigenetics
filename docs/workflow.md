...
**Status:** **IN PROGRESS — notebooks 600–602 complete under frozen specifications; notebook 603 pending prospective design/freeze.**
...
- **Notebook 603 boundary:** cross-screen replication remains pending prospective freeze. CTRP and PRISM replication outcomes must not be inspected to retrospectively tune notebook-601 models or notebook-602 attribution decisions.
